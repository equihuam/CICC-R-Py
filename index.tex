...
{\centering \includegraphics[width=2.08333in,height=\textheight,keepaspectratio]{img/Page01.jpg}

}

\caption{Códice Fejérváry-Mayer}
...
\begin{center}
\includegraphics[width=4.16667in,height=\textheight,keepaspectratio]{img/rey-de-la-cueva.jpg}
\end{center}
...
que sepamos, entre los siglos XVI y XVIII (quizás hasta el XIX). Se
vivieron allá condiciones climáticas con un gran descenso de las
temperaturas. Dejó huellas tanto en la vida social como en la economía
de todo el continente.

\begin{figure}[H]

{\centering \includegraphics[width=2.08333in,height=\textheight,keepaspectratio]{img/Les_Très_Riches_Heures_du_duc_de_Berry_février.jpg}
...
\tightlist
\item[$\square$]
  Preparar una exposición con apoyo visual (powerpoint), enlaque
  expliquen lo que desee decir a lo largo de entre 40 y 50 minutos. Se
  pueden grabar ustedes mismos con apoyo de zoom, como si estuvieran en
  una video conferencia, o si lo prefieren podríamos tener una verdadera
  videoconferenciay grabarnos mientras charlamos.
\item[$\square$]
  Indicar una o dos referencias básicas
\item[$\square$]
  Recomendar tres o cuatro referencias de interés para profundizar en la
  temática.
\item[$\square$]
  Una breve semblanza biográfica
\item[$\square$]
  Una fotografía de 1200x1600pixeles (jpg o png), en arreglo vertical.
  Que no ocupe más de 2 megas en disco.
\item[$\square$]
...
\href{Referencias/539_R_08_historicidad_c.pdf}{Los Altépetl}

\href{Referencias/clima\%20durante\%20vida\%20de\%20Miguel\%20de\%20Cervantes.pdf}{¿Cómo
eran las condiciones climáticas en la vida de Miguel decervantes?}

\href{Referencias/Dialnet-ElAltepetlNahuaComoPaisaje-7425612.pdf}{El
altepetl nahua como paisaje}

\href{Referencias/El\%20Rey\%20de\%20las\%20entrañas\%20de\%20la\%20tierra\%20al\%20cielo.\%20(Chalcatzingo,\%20Morelos)\%20-\%20Ark.\%20Experiencias.pdf}{El
Rey de las entrañas de la tierra al cielo. (Chalcatzingo, Morelos)}

\href{Referencias/Global\%20Crisis\%20of\%20the\%20Seventeenth\%20Century.pdf}{The
Global Crisis of the Seventeenth Century}

\href{Referencias/Guerra-clima-catástrofe.pdf}{Guerra, clima y
catástrofe: una reconsideración de la crisis general del siglo XVII y de
la decadencia de España}

\href{Referencias/Moore-extracted-text-La-crisis-climatica-es-una-lucha-de-clases-2021-July-Jacobin-Latin-America.pdf}{La
